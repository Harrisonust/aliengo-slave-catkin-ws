...
"""autogenerated by genpy from slam_planner/HighState.msg. Do not edit."""
import sys
...
float32 z"""
  ...
  _slot_types = ['uint8','uint16','uint16','uint32','uint8','uint8','slam_planner/IMU','float32','float32','float32','float32','float32','float32','float32','slam_planner/Cartesian[4]','slam_planner/Cartesian[4]','int16[4]','int16[4]','uint32','uint8[40]','uint32','uint32','slam_planner/Cartesian[4]','float32[12]']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.footPosition2Body is None:
        self.footPosition2Body = [slam_planner.msg.Cartesian() for _ in range(4)]
      if self.footSpeed2Body is None:
        self.footSpeed2Body = [slam_planner.msg.Cartesian() for _ in range(4)]
