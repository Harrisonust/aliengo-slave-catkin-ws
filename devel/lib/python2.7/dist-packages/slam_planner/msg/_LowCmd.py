...
"""autogenerated by genpy from slam_planner/LowCmd.msg. Do not edit."""
import sys
...
float32 z"""
  ...
  _slot_types = ['uint8','uint16','uint16','uint32','uint8','slam_planner/MotorCmd[20]','slam_planner/LED[4]','uint8[40]','uint32','uint32','slam_planner/Cartesian[4]']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.motorCmd is None:
        self.motorCmd = [slam_planner.msg.MotorCmd() for _ in range(20)]
      if self.led is None:
      ...
      if self.crc is None:
        self.crc = 0
      if self.ff is None:
        self.ff = [slam_planner.msg.Cartesian() for _ in range(4)]
    else:
      self.levelFlag = 0
      self.commVersion = 0
      self.robotID = 0
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.motorCmd = []
      for i in range(0, 20):
        val1 = slam_planner.msg.MotorCmd()
        _x = val1
        start = end
        end += 21
